...
plot(India_GDP_Data$Year,India_GDP_Data$GDP_In_Billion_USD, xlab="Year", ylab="Real GDP",  main="The Graph of Real GDP")
...
gdpforecast=forecast(gdpmodel,level = c(95),h = 10*1)
gdpforecast
plot(gdpforecast)